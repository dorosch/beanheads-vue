...
<template>
  ...
  <path
    ...
    stroke-width="12px"
  />
  <path d="M678.92,968.3c3.8.3,15-1.18,15.42-.76" :fill="white" />
  <path
  ...
  <polyline
    ...
    stroke-width="8px"
  />
  <path d="M638.1,969.06c7.51-.71,21.51-.89,34-.67" :fill="white" />
  <path
    ...
    :fill="outline"
  />
  <circle cx="515.77" cy="982.93" r="4.8" :fill="outline" />
  <path
